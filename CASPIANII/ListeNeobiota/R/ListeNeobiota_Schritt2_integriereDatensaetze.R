...
integriereDatensaetze <- function(){
  ...
  final_dataset$ArtGruppe[final_dataset$Klasse=="Mammalia"] <- "Saeugetiere"
  final_dataset$ArtGruppe[final_dataset$Klasse=="Aves"] <- "Voegel"
  final_dataset$ArtGruppe[final_dataset$Klasse%in%c("Cephalaspidomorphi","Actinopterygii","Elasmobranchii","Sarcopterygii")] <- "Fische"
  final_dataset$ArtGruppe[final_dataset$Ordnung%in%c("Cypriniformes","Acipenseriformes","Clupeiformes","Siluriformes","Anguilliformes","Perciformes","Salmoniformes","Gasterosteiformes","Scorpaeniformes","Cyprinodontiformes","Characiformes","Beloniformes","Esociformes")] <- "Fische"
  final_dataset$ArtGruppe[final_dataset$Klasse%in%c("Reptilia","Testudines","Squamata")] <- "Reptilien"
  ...
  # final_dataset$ArtGruppe[final_dataset$scientificName%in%arthropods_nocrustaceans$scientificName] <- "Arthropods (excl. crustaceans)"
  ...
  final_dataset$ArtGruppe[final_dataset$Klasse%in%c("Diplopoda","Diplura","Collembola","Chilopoda","Symphyla","Merostomata","Branchiopoda","Hexanauplia","Maxillopoda","Ostracoda","Malacostraca","Copepoda")] <- "Andere Arthropoden"
  final_dataset$ArtGruppe[final_dataset$phylum%in%c("Arthropoda") & is.na(final_dataset$ArtGruppe)] <- "Andere Arthropoden"
  final_dataset$ArtGruppe[final_dataset$Phylum=="Mollusca"] <- "Weichtiere"
  final_dataset$ArtGruppe[final_dataset$Phylum=="Tracheophyta"] <- "Hoehere Pflanzen"
  ...
  final_dataset$ArtGruppe[final_dataset$Reich%in%c("Alsuviricetes","Stelpaviricetes","Pisoniviricetes","Ellioviricetes","Pisuviricota")] <- "Viren"
