...
# 
# Dieses Skript fuehrt den workflow "ListeNeobiota" aus, bei dem einzelne Listen 
# von Neobiota standardisiert und integriert werden. Hierzu wird eine Reihe von 
# Skripten ausgefuehrt, die in fuenf Arbeitsschritten aufgeteilt sind:
#
# 1. Standardisierung der Rohdatensaetze: Die Spaltennamen und Eintraege der 
#    Rohdatensaetze werden standardisiert.
# 2. Integration der standardisierten Datensaetze: Die standardisierten Datensaetze 
#    werden zu einem Datensatz integriert und Duplikate werden entfernt.
# 3. GBIF Eintraege ermitteln: Fuer jede Art wird die Anzahl an verfuegbaren 
#    Eintraegen in GBIF ermittelt.
# 4. Ergaenzung der Ausbringungspfadd: Informationen zum Ausbringspfaden werden 
#    sofern vorhanden ergaenzt.
# 5. sMon Eintraege ermitteln: Fuer jede Art wird die Anzahl an verfuegbaren 
#    Eintraegen in sMon ermittelt.
# 6. Deutsche Artnamen werden ermittelt und hinzugefuegt.
#
...
# Vor Durchfuehrung dieses Workflows muessen die zu integrierenden Listen der 
# Neobiota in der Datei "ListeGebietsfremderArten_Rohdaten.xlsx" zusammengefuehrt 
# werden. Jede Liste muss in ein Tabellenblatt kopiert werden, welches mit dem 
# Kuerzel der Quelle beschriftet sein sollte. Jedes Tabellenblatt sollte als 
# Mindestanforderung eine Spalte mit Namen  der Organismen haben, die mit 
# "WissenschaftlicherName", "Taxon" or "scientificName" ueberschrieben sein muss.

################################################################################
# Schritt 1 - Vorbereiten der Datensaetze: Datensaetze werden eingelesen, 
# Spaltenname und taxonomische Namen standardisiert.
...
cat("\nSchritt 2a: entferne einheimische Arten\n")
bereinigeListe()
...
# Schritt 4 - Pfade: Ergaenzung von Informationen zu Pfade der Einbringung und 
# Ausbreitung
...
################################################################################
# Schritt 5 - sMon Eintraege: Ermittlung der Eintraege von verfuegbaren sMon 
# Daten
