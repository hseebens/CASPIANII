##########################################################################
#
# Mit diesem Skript kann das Modell CASPIAN kalibriert werden. Hierfür
# müssen eine geeignete Art und die zu kalibrierenden Parameter ausgewählt
# werden. 
# Für die ausgewählte Art müssen Vorkommensdaten zu unterschiedlichen
# Zeitpunkten vorliegen, die eine räumliche Ausbreitung der Art erkennen
# lassen. Die Daten müssen im File Vorkommen_[Artname]_Kalibrierung.csv
# im Verzeichnis "CASPIAN/Daten/" vorliegen ("[Artname]" muss durch den 
# jeweiligen Artnamen ersetzt werden).
#
...
path2data <- file.path("CASPIAN", "Daten", "Input") #, "Modelldaten"
