...
Vorhersage_alleLaeufe <- function(TaxonName,
  ...
  allenvir <- stack(file.path("Data","Input",paste0("UmweltdatenRaster_",TaxonName,"_",identifier,".grd")))
  ...
  if (speichern){
    ...
    fwrite(all_preds_singlefile, file=file.path("Data","Output", paste0("HabitatEignung_",TaxonName,"_",identifier,".gz"))) 
  }
